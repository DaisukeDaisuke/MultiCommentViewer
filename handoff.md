...
- Twitch サブスク系 USERNOTICE は TwitchNotice のまま IsSubscription を立て、通常 Notice とは別の SubscriptionNoticeBackColor/SubscriptionNoticeForeColor で表示できるようにした。既定は紫背景 #FF5E35B1、白文字。
