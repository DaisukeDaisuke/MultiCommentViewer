...
namespace Dwango.Nicolive.Chat.Service.Edge {
  ...
  #endif
  {
    ...
    public global::Dwango.Nicolive.Chat.Service.Edge.ChunkedMessage.Types.Signal Signal {
      get { return payloadCase_ == PayloadOneofCase.Signal ? (global::Dwango.Nicolive.Chat.Service.Edge.ChunkedMessage.Types.Signal) payload_ : global::Dwango.Nicolive.Chat.Service.Edge.ChunkedMessage.Types.Signal.Flushed; }
      set {
        payload_ = value;
